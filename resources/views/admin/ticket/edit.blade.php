                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="category" class="form-control select2">
                                        <option value="silver" {{$ticket->category == "silver"?'selected':''}}>{{ __('SILVER') }}</option>
                                        <option value="gold" {{$ticket->category == "gold"?'selected':''}}>{{ __('GOLD') }}</option>
                                        <option value="vip" {{$ticket->category == "vip"?'selected':''}}>{{ __('VIP') }}</option>
                                    </select>
                                    @error('category')
                                        <div class="invalid-feedback">{{$message}}</div>
                                    @endif
